...
class LifecycleHandler {
  constructor() {
    this.version = process.env.FCA_FIREBOLT_SDK_VERSION;
    logger.info(`LifecycleHandler initialized with version: ${this.version}.x`, 'LifecycleHandler.js');
...
class LifecycleVersion1 {
  ...
  async handle(methods) {
    ...
    switch (method) {
      case CONSTANTS.LIFECYCLE_METHODS_V1.READY:
        try {
        ...
        break;
      case CONSTANTS.LIFECYCLE_METHODS_V1.STATE:
        /*
        ...
        break;
      case CONSTANTS.LIFECYCLE_METHODS_V1.CLOSE:
        try {
        ...
        break;
      case CONSTANTS.LIFECYCLE_METHODS_V1.HISTORY:
        try {
        ...
        break;
      case CONSTANTS.LIFECYCLE_METHODS_V1.ON_INACTIVE:
        if (process.env.STANDALONE == true) {
          try {
        ...
        break;
      case CONSTANTS.LIFECYCLE_METHODS_V1.ON_FOREGROUND:
        if (process.env.STANDALONE == true) {
          try {
        ...
        break;
      case CONSTANTS.LIFECYCLE_METHODS_V1.ON_BACKGROUND:
        if (process.env.STANDALONE == true) {
          try {
        ...
        break;
      case CONSTANTS.LIFECYCLE_METHODS_V1.FINISHED:
        /**
        ...
        response = this.createResultObject(result.response, result.error);
        break;
      case CONSTANTS.LIFECYCLE_METHODS_V1.BACKGROUND:
        result = await this.lifecycleMethodCalls(method, params);
        response = this.createResultObject(result.response, result.error);
        break;
      case CONSTANTS.LIFECYCLE_METHODS_V1.SUSPEND:
        result = await this.lifecycleMethodCalls(method, params);
        response = this.createResultObject(result.response, result.error);
        break;
      case CONSTANTS.LIFECYCLE_METHODS_V1.UNSUSPEND:
        result = await this.lifecycleMethodCalls(method, params);
        response = this.createResultObject(result.response, result.error);
        break;
      default:

...
// Mock constants module so webpack issues with FirenboltSdkManager.js are resolved
jest.mock('../src/constant', () => {
  const CONSTANTS = {
    ...
    PLATFORM_LIST: [],
    ENTOS_OPENRPC_URL: 'https://firecertentosopenrpc.firecert.comcast.com',
    EXTENSION_SDK: 'extensionSDK',
    ENTOS: 'entos',
    TEST_TOKEN: 'x-firebolt-testtoken',
    PRODUCT: 'x-firebolt-product',
    MAC: 'x-firebolt-mac',
    SDK_VERSION: 'x-firebolt-sdk-version',
    ACTION: 'x-firebolt-action',
    FORCE_CACHE_UPDATE: 'x-firebolt-force-cache-update',
    GET_METHOD: 'GET',
    ERROR: 'error',
    RESULT: 'result',
    FUNCTION: 'function',
    SUCCESS_SUBSTRING: 'Successful',
    OBJECT: 'object',
    PROPERTIES: 'properties',
    SCHEMA_UNDEFINED: 'Schema is undefined',
    EVENT: 'event',
    ON_LISTENER: '.on',
    UUID_CENSORED: 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx',
    FIREBOLT_SDK_VERSION_LABEL: 'Firebolt SDK Version',
    VERSION_LABEL: 'Version',
    MODE_LABEL: 'Mode',
    FIRMWARE_LABEL: 'Firmware',
    HASH_VERSION_LABEL: 'Hash',
    APPID_LABEL: 'AppId',
    DEBUG: 'debug',
    REPORT_STATUS: {
      SKIPPED: 'skipped',
